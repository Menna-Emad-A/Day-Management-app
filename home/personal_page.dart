...
class PersonalTaskPage extends StatefulWidget {
  ...
  final VoidCallback onTaskChanged; // Callback to notify task changes
...
class _PersonalTaskPageState extends State<PersonalTaskPage> {
  ...
  late Future<List<Map<String, dynamic>>> _personalTasksFuture;
  ...
  void _loadPersonalTasks() {
    setState(() {
      _personalTasksFuture = _fetchPersonalTasks();
    });
  }

  Future<List<Map<String, dynamic>>> _fetchPersonalTasks() async {
    int userId = widget.user['UUser_ID'];
    List<Map<String, dynamic>> allTasks = await dbHelper.getUserTasks(userId);
    return allTasks.where((task) => task['TType'] == 'Personal').toList();
  }
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            TaskCard(
                              task: task,
                              onRefresh: () {
                                _loadPersonalTasks(); // Refresh local tasks
