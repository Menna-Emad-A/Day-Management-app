...
class _OfficePageState extends State<OfficePage> {
  ...
  late Future<List<Map<String, dynamic>>> _officeTasksFuture;
  ...
  void _loadOfficeTasks() {
    setState(() {
      _officeTasksFuture = _fetchOfficeTasks();
    });
  }

  Future<List<Map<String, dynamic>>> _fetchOfficeTasks() async {
    int userId = widget.user['UUser_ID'];
    return await dbHelper.getTasksByCategory(userId, 'Office');
  }
    ...
    return Scaffold(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TaskCard(
                          task: task,
                          onRefresh: () {
                            _loadOfficeTasks(); // Refresh the list
                            widget.onTaskChanged(); // Notify homepage
                          },
                        );
                      },
                    );
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          if (result == true) {
            _loadOfficeTasks(); // Refresh tasks
            widget.onTaskChanged(); // Notify homepage
          }
        },
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await dbHelper.updateTask(
                              task['TTask_ID'], {'TStatus': 'Deleted'});
                          onRefresh(); // Refresh tasks and notify parent
                        },
