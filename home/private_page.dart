...
class _PrivatePageState extends State<PrivatePage> {
  ...
  late Future<List<Map<String, dynamic>>> _privateTasksFuture;
  ...
  void _loadPrivateTasks() {
    setState(() {
      _privateTasksFuture = _fetchPrivateTasks();
    });
  }

  Future<List<Map<String, dynamic>>> _fetchPrivateTasks() async {
    int userId = widget.user['UUser_ID'];
    List<Map<String, dynamic>> allTasks = await dbHelper.getUserTasks(userId);
    return allTasks.where((task) => task['TType'] == 'Private').toList();
  }
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            TaskCard(
                              task: task,
                              onRefresh: () {
                                _loadPrivateTasks(); // Refresh private tasks
